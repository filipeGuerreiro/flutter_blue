...
class AnnouncedServicesResult extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AnnouncedServicesResult', createEmptyInstance: create)
    ..pc<BluetoothService>(1, 'services', $pb.PbFieldType.PM, subBuilder: BluetoothService.create)
    ..hasRequiredFields = false
  ;

  AnnouncedServicesResult._() : super();
  factory AnnouncedServicesResult() => create();
  factory AnnouncedServicesResult.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory AnnouncedServicesResult.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  AnnouncedServicesResult clone() => AnnouncedServicesResult()..mergeFromMessage(this);
  AnnouncedServicesResult copyWith(void Function(AnnouncedServicesResult) updates) => super.copyWith((message) => updates(message as AnnouncedServicesResult));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static AnnouncedServicesResult create() => AnnouncedServicesResult._();
  AnnouncedServicesResult createEmptyInstance() => create();
  static $pb.PbList<AnnouncedServicesResult> createRepeated() => $pb.PbList<AnnouncedServicesResult>();
  @$core.pragma('dart2js:noInline')
  static AnnouncedServicesResult getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<AnnouncedServicesResult>(create);
  static AnnouncedServicesResult _defaultInstance;

  @$pb.TagNumber(1)
  $core.List<BluetoothService> get services => $_getList(0);
}
