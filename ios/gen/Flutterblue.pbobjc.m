...
#import "protos/Flutterblue.pbobjc.h"
...
#pragma mark - ProtosCreateServiceRequest

@implementation ProtosCreateServiceRequest

@dynamic uuid;
@dynamic isPrimary;

typedef struct ProtosCreateServiceRequest__storage_ {
  uint32_t _has_storage_[1];
  NSString *uuid;
} ProtosCreateServiceRequest__storage_;
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    static GPBMessageFieldDescription fields[] = {
      {
        .name = "uuid",
        .dataTypeSpecific.className = NULL,
        .number = ProtosCreateServiceRequest_FieldNumber_Uuid,
        .hasIndex = 0,
        .offset = (uint32_t)offsetof(ProtosCreateServiceRequest__storage_, uuid),
        .flags = GPBFieldOptional,
        .dataType = GPBDataTypeString,
      },
      {
        .name = "isPrimary",
        .dataTypeSpecific.className = NULL,
        .number = ProtosCreateServiceRequest_FieldNumber_IsPrimary,
        .hasIndex = 1,
        .offset = 2,  // Stored in _has_storage_ to save space.
        .flags = GPBFieldOptional,
        .dataType = GPBDataTypeBool,
    ...
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:[ProtosCreateServiceRequest class]
                                     rootClass:[ProtosFlutterblueRoot class]
                                          file:ProtosFlutterblueRoot_FileDescriptor()
                                        fields:fields
                                    fieldCount:(uint32_t)(sizeof(fields) / sizeof(GPBMessageFieldDescription))
                                   storageSize:sizeof(ProtosCreateServiceRequest__storage_)
                                         flags:GPBDescriptorInitializationFlag_None];
    #if defined(DEBUG) && DEBUG
      NSAssert(descriptor == nil, @"Startup recursed!");
    #endif  // DEBUG
