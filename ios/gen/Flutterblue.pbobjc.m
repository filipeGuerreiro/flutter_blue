...
#pragma mark - ProtosAnnouncedServicesResult

@implementation ProtosAnnouncedServicesResult

@dynamic servicesArray, servicesArray_Count;

typedef struct ProtosAnnouncedServicesResult__storage_ {
  uint32_t _has_storage_[1];
  NSMutableArray *servicesArray;
} ProtosAnnouncedServicesResult__storage_;
    ...
    static GPBMessageFieldDescription fields[] = {
      {
        .name = "servicesArray",
        .dataTypeSpecific.className = GPBStringifySymbol(ProtosBluetoothService),
        .number = ProtosAnnouncedServicesResult_FieldNumber_ServicesArray,
        .hasIndex = GPBNoHasBit,
        .offset = (uint32_t)offsetof(ProtosAnnouncedServicesResult__storage_, servicesArray),
        .flags = GPBFieldRepeated,
        .dataType = GPBDataTypeMessage,
      },
    };
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:[ProtosAnnouncedServicesResult class]
                                     rootClass:[ProtosFlutterblueRoot class]
                                          file:ProtosFlutterblueRoot_FileDescriptor()
                                        fields:fields
                                    fieldCount:(uint32_t)(sizeof(fields) / sizeof(GPBMessageFieldDescription))
                                   storageSize:sizeof(ProtosAnnouncedServicesResult__storage_)
                                         flags:GPBDescriptorInitializationFlag_None];
    #if defined(DEBUG) && DEBUG
      NSAssert(descriptor == nil, @"Startup recursed!");
    #endif  // DEBUG
