...
typedef GPB_ENUM(ProtosCreateServiceRequest_FieldNumber) {
  ProtosCreateServiceRequest_FieldNumber_Uuid = 1,
  ProtosCreateServiceRequest_FieldNumber_IsPrimary = 2,
};

@interface ProtosCreateServiceRequest : GPBMessage
