...
typedef GPB_ENUM(ProtosAnnouncedServicesResult_FieldNumber) {
  ProtosAnnouncedServicesResult_FieldNumber_ServicesArray = 1,
};

@interface ProtosAnnouncedServicesResult : GPBMessage
